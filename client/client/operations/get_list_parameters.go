...
// WithDefaults hydrates default values in the get list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetListParams) WithDefaults() *GetListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetListParams) SetDefaults() {
